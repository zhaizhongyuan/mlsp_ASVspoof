...
def traingmm(train_path, dest, feature_type):
    ...
    gmm_bon = GMM(n_components = 512, covariance_type='diag',n_init = 1,verbose=2, max_iter=2000, warm_start=True) # min shape[0] = 135 # max = 1112
    # 2580 1112 337.8709302325581 289
    # gmm_sp  = GMM(n_components = 144, covariance_type='diag',n_init = 1,verbose=2, max_iter=1500, warm_start=True)  # min shape[0] = 64  # max = 1318
