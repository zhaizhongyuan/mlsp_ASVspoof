...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", required=False, type=str,  default='../data/train', help='path to pickled file. For example, data/train.pkl')
    ...
    parser.add_argument("--feature_type", required=False, type=str, default='lfcc', help='select the feature type. lfcc or mfcc')
